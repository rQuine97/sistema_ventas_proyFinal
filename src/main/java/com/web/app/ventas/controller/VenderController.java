...
import com.web.app.ventas.model.ProductoParaVender;
...
import com.web.app.ventas.repository.ProductosVendidosRepository;
...
public class VenderController {
    ...
    public String agregarAlCarrito(@ModelAttribute Producto producto, HttpServletRequest request, RedirectAttributes redirectAttrs) {
        ...
        if (!encontrado) {
            carrito.add(new ProductoParaVender(productoBuscadoPorCodigo.getNombre(), productoBuscadoPorCodigo.getCodigo(), productoBuscadoPorCodigo.getPrecio(), productoBuscadoPorCodigo.getExistencia(), productoBuscadoPorCodigo.getId(), productoBuscadoPorCodigo.getImagen(), 1f));
            //carrito.add(new Prod);
        }
        this.guardarCarrito(carrito, request);
        return "redirect:/vender/";
    }
